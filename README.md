...
<p>Image Source: <a href = "https://en.wikipedia.org/wiki/Transformer_\(machine_learning_model\" alt="">wikipedia</a>

The diagram above describes the pipeline between the input, output and positional encoding. For more information on Transformer Architecture visit this <a href = "https://en.wikipedia.org/wiki/Transformer_\(machine_learning_model\" alt="">wikipedia</a> page.</p>
